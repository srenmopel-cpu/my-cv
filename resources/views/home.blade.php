        ...
        <div class="education-grid reveal">
            ...
            <div class="education-card p-8 slide-in">
                <div class="flex flex-col items-center text-center">
                    ...
                    <h3 class="text-2xl font-semibold text-white mb-2">Cambodia University of Management and Technology
                    </h3>
                    <p class="text-red-400 font-medium mb-2">Tech University</p>
                    <p class="text-red-300 mb-4">2023 - Present</p>
            ...
            <div class="education-card p-8 slide-in">
                <div class="flex flex-col items-center text-center">
                    ...
                    <h3 class="text-2xl font-semibold text-white mb-2">Raksmey islam Cambodia High School</h3>
                    <p class="text-red-400 font-medium mb-2">Tech High School</p>
                    <p class="text-red-300 mb-4">2020-2022</p>
                    <p class="text-gray-300">Studied core subjects including Khmer Language, Mathematics, Physics, and
                        Biology

                        Developed strong skills in logical thinking, scientific reasoning, and analytical
                        problem-solving

                        Performed well in national examinations and academic assessments

                        Built a solid foundation for further studies and a future career in science and technology</p>
                </div>
            </div>
            ...
            <div class="education-card p-8 slide-in">
                <div class="flex flex-col items-center text-center">
                    ...
                    <h3 class="text-2xl font-semibold text-white mb-2">Russey Keo High School </h3>
                    <p class="text-red-400 font-medium mb-2">Tech High School</p>
                    <p class="text-red-300 mb-4">2018 - 2020</p>
                    <p class="text-gray-300">Studied core subjects including Khmer Language, Mathematics, Physics, and
                        Biology
